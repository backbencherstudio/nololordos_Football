...
class FwdGoalscoresheet extends StatelessWidget {
  ...
  builder: (context, ref, _) {
    ...
    final players = allPlayers
        .where((p) => p['position'] == "FWD" || p['position'] == "Forward (FWD)")
                  ...
                  if (isDeleteOn) ...[
                    Transform.scale(
                      ...
                      child: Checkbox(
                        ...
                        fillColor: MaterialStateProperty.all(selectedFwdPlayers.contains(index) ? AppColors.redColor : Colors.transparent),
                        value: selectedFwdPlayers.contains(index), // Individual checkbox state for forwards
                        onChanged: (bool? value) {
