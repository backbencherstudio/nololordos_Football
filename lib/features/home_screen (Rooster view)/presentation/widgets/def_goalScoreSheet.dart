        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, _) {
              ...
              final selectAllDef = false; // Track "select all" state for DEF
              final selectedDefenders =
                  []; // Track individual selected players for DEF
                      ...
                      if (isDeleteOn) ...[
                        Transform.scale(
                          ...
                          child: Checkbox(
                            ...
                            value:
                                selectAllDef, // "Select all" checkbox state for DEF
                            ...
                            if (isDeleteOn) ...[
                              Transform.scale(
                                ...
                                child: Checkbox(
                                  ...
                                  value: selectedDefenders.contains(
                                    index,
                                  ), // Individual checkbox state for DEF
                                  onChanged: (bool? value) {
