        ...
        children: [
          Consumer(
            builder: (context, ref, _) {
              ...
              final selectAllMID = false; // Track "select all" state for MID
              final selectedPlayers = []; // Track individual selected players
                      ...
                      if (isDeleteOn) ...[
                        Transform.scale(
                          ...
                          child: Checkbox(
                            ...
                            value:
                                selectAllMID, // "Select all" checkbox state for MID
                            ...
                            if (isDeleteOn) ...[
                              Transform.scale(
                                ...
                                child: Checkbox(
                                  ...
                                  value: selectedPlayers.contains(
                                    index,
                                  ), // Individual checkbox state for midfielders
                                  onChanged: (bool? value) {
